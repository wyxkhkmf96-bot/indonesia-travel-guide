const days = [
  {
    tab:'抵达泗水',date:'DAY 01 · 09.27 SUN',title:'上海出发，抵达东爪哇',route:'上海浦东 → 短转机 → 泗水朱安达机场 → 市区酒店',energy:'低\n恢复日',cost:'¥1,100—1,800',hotel:'Mövenpick Surabaya City',hotelPrice:'两间约 ¥900—1,400',safety:'只选一张联程票，转机以 2—4 小时为目标；落地后不再赶 4 小时山路。',
    agenda:[['上午','上海浦东出发','接受 1 次转机；优先行李直挂，转机 2—4 小时，总时长控制在 10—14 小时。'],['16:00—20:00','抵达泗水','入境、取行李、ATM 小额取现；司机举姓名牌接机。'],['落地后 90min','酒店入住','只在酒店附近吃熟食，和 Java 团确认次日 07:00 接车。'],['22:30 前','睡觉','整理瀑布防滑鞋和速干衣，主箱留车上。']],
  ...
  },
  {
    ...
    points:[['外南梦',114.369,-8.219],['伊真火山',114.242,-8.058],['吉打邦港',114.402,-8.160],['吉利马努克',114.437,-8.165],['洛维纳',115.024,-8.161]],segments:['road','road','boat','road'],photos:[['ijen-blue-fire.jpg','伊真蓝火 · 受风向和管制影响'],['ijen-blue-fire.jpg','9/30 进入，避开 10/2 官方关闭'],['bromo.jpg','火山后去 Lovina 完整休息']]
  },
  {
    tab:'北巴厘→乌布',date:'DAY 05 · 10.01 THU',title:'火山后的恢复型穿越',route:'Lovina → Kintamani → Leke Leke → Ubud',energy:'中\n轻徒步',cost:'¥950—1,500',hotel:'Dinara Ubud',hotelPrice:'两间约 ¥1,800—2,400',safety:'不安排凌晨追海豚；今天睡够再走，司机连续驾驶需明确休息。',
  ...
  {
    tab:'飞科莫多',date:'DAY 08 · 10.04 SUN',title:'先飞到，再谈出海',route:'Sanur → DPS → Labuan Bajo',energy:'低\n缓冲日',cost:'¥1,050—2,400',hotel:'Loccal Collection Komodo',hotelPrice:'两间约 ¥2,100—2,500',safety:'必须搭上午/中午航班；当天不订不能退的出海或日落船。',
  ...
  {
    tab:'开口程返沪',date:'DAY 10 · 10.06 TUE',title:'从科莫多直接向北回家',route:'Labuan Bajo → Singapore → Shanghai',energy:'中\n飞行日',cost:'¥300—600',hotel:'返上海',hotelPrice:'不回巴厘岛 · 优先一张联程票',safety:'只买同一订单且行李直挂的组合，转机目标 2—5 小时；若是分票自转，至少留 7 小时。',
    agenda:[['起飞前 3H','酒店退房去 LBJ','核对行李能否直挂 PVG；不能直挂就按分票方案重新评估。'],['白天','LBJ 直飞新加坡','Scoot 当前每周约 3 班，周二是优先窗口；实际以出票页为准。'],['目标 2—5H','樟宜机场转机','同一订单可走联程；若需要入境取行李，2—5 小时不够，必须改 ≥7 小时。'],['夜间','SIN 直飞 PVG','不再回巴厘岛；保险、登机牌和费用票据保留至回国后。']],
    points:[['拉布安巴焦',119.889,-8.496],['新加坡',103.991,1.364],['上海',121.805,31.144]],segments:['flight','flight'],photos:[['labuan_bajo.jpg','从 Labuan Bajo 直接离开印尼'],['padar.jpg','科莫多出海安排在前一天'],['batur.jpg','开口程不再回飞巴厘岛']]
  }
];
